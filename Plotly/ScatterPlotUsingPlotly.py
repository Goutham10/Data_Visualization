...
scatterplot.layout.updatemenus[0].buttons[0].args[1]['frame']['duration'] = 1000   # second to change from one frame to another frame
scatterplot.layout.updatemenus[0].buttons[0].args[1]['transition']['duration'] = 3000 # seconds to change the transition of points in the plot 
